...
# Telegram Bot
infogempamassbot = "1709495388:AAEKOEDBJjaYs9aacCSt1W7jiznGHc2Y92U"
bot = telebot.TeleBot(infogempamassbot)
...
def start_bubu(message):
	...
	text = message.text
	sca(bubu, 'typing')
	sm(bubu , "Assalamu'alaikum sayangkuu ☺️")
	sca(bubu, 'typing')
	sm(bubu , 'Kali ini Mass ada bot baru loh')
	sca(bubu, 'typing')
	sm(bubu , 'Bot ini memberitahukan informasi gempa bumi terkini')
	sca(bubu, 'typing')
	sm(bubu , 'Kalau mau info lebih lanjut silakan hubungi Mass')
	sca(bubu, 'typing')
